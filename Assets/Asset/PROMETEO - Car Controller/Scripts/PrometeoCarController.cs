...
public class PrometeoCarController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (AnyWheelEnabled() && carRigidbody != null)
        {
            // ���������� �������� Rigidbody (�/� -> ��/�) � ��� �������, ��� ��������� �� RPM ������ ������.
    ...
    bool AnyWheelEnabled()
    {
        try
        {
            return (frontLeftCollider != null && frontLeftCollider.enabled)
                || (frontRightCollider != null && frontRightCollider.enabled)
                || (rearLeftCollider != null && rearLeftCollider.enabled)
                || (rearRightCollider != null && rearRightCollider.enabled);
        }
        catch
        {
            return false;
    ...
    public int GetSpeed()
    {
        if (!AnyWheelEnabled()) return 0;
        float absoluteCarSpeed = Mathf.Abs(carSpeed);
        return Mathf.RoundToInt(absoluteCarSpeed);
    }
